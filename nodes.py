    ...
    def define_schema(cls) -> io.Schema:
        return io.Schema(
            ...
            inputs=[
                ...
                io.Combo.Input(
                    "weight_quantization",
                    options=modeling.WEIGHT_QUANTIZATION_OPTIONS,
                    default="auto",
                    advanced=True,
                    tooltip="auto uses int8_convrot for the MOSS DiT on supported CUDA ComfyUI installs; off keeps original weights.",
                ),
